...
const defaultConfig = {
    ...
    core: {
         ...
         * a file path to append logs to, or if you are using input redirection to attach additioanl open file
         * descriptors a number indicating the file drscriptor to write to.
         *
         * @default
         * @type {number|string}
         */
