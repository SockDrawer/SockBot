...
exports.bindCommands = function bindCommands(forum) {
    ...
    class Commands {
         ...
         */
        static get(notification, postBody) {
            return new Promise((resolve) => {
                const rawData = utils.htmlToRaw(postBody);
                resolve(new Commands(notification, rawData));
            });
        }
    ...
    function onComplete(commands) {
        ...
        return forum.Post.reply(commands.ids.topic,
            commands.ids.post, content);
    }
