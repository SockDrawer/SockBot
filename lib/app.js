 ...
 * @returns {strung} User-Agent to use for a forum instance
 */
exports.getUserAgent = function getUserAgent(cfg) {
    return `${packageInfo.name}/${packageInfo.version} (${process.platform} ${process.arch}) (nodejs v${process.versions.node}) (v8 v${process.versions.v8}) (user:${cfg.core.username} owner:${cfg.core.owner})`;
};
