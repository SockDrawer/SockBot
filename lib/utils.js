 ...
 */
exports.filterIgnoredOnPost = function filterIgnoredOnPost(post, callback) {
 ...
 * @returns {null} No return value
 */
exports.filterIgnoredOnTopic = function filterIgnoredOnTopic(topic, callback) {
    const flow = (err, msg) => setTimeout(() => callback(err, msg), 0),
        ignoredUsers = config.core.ignoreUsers,
 ...
 */
exports.filterIgnored = function filterIgnored(topic, post, callback) {
    async.parallel([
        (cb) => {
            exports.filterIgnoredOnPost(post, cb);
        }, (cb) => {
            exports.filterIgnoredOnTopic(topic, cb);
        }
    ], (err, reason) => {
        if (err) {
